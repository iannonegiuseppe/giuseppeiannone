// EN-slug folder for milanPath's own "/en/psychologist-milan" output —
// same dual-folder pattern as chi-sono/about-me, metodo/method, prezzi/
// pricing, contatti/contact (one literal folder per locale's translated
// slug; next-intl's routing here doesn't auto-translate path segments).
// Re-exports the real implementation wholesale rather than duplicating
// it: this route's content and behavior are locale-driven (the `locale`
